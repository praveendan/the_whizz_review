...
import { json } from "./res/kcs_survey_question.js";
...
export function KCSSurveyPage() {
  const dbCollectionInstance = dbInstance.collection("kcs_responses");
  ...
  function onComplete(sender, options) {
    dbCollectionInstance.add(sender.data)
    .then((_docRef) => {
